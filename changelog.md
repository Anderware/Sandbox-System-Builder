...
- Changes for Foundry v12 compability  
  - Too many to list!

## Version 0.14.4.5(2024-05-02)
- FIX: 1/5 panels were not added for resize
- FIX: 1/5 panels were not added for multipanels
- FIX: Checkboxes with custom images in tables
- Added tooltips for textareas in tables
- FIX: When adding a new actor/item, non-gms got a error in console "foundry.js:68327 User xxxx lacks permission to update Actor/item [3W0gRXHMlxaAI9PB]" 
- CHANGE: Sandbox API function _ActorProperty_RemoveProperty is renamed to ActorProperty_RemoveProperty
- Added option in Actor Property Manager to remove selected actor property for all actors
- Added system menu command "Reload All Actors"
