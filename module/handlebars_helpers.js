export function registerHandlebarsHelpers() {
  ...
  Handlebars.registerHelper("parseListOptions", function(str) {
  ...
  Handlebars.registerHelper('usesModule', function (moduleId,options) { 
  ...
  Handlebars.registerHelper('isGMOrcItemOwner', function (ciKey,options) {  // argument cikey not needed/used
    if (game.user.isGM) {
      return options.fn(this);
    }
    //console.log(this);
    const citem = this.item;
    
    //console.log(citem)
    if (citem!=null){
      if(citem.testUserPermission(game.user,CONST.DOCUMENT_OWNERSHIP_LEVELS.OWNER)){
        return options.fn(this);
      }
    }
    return options.inverse(this);
